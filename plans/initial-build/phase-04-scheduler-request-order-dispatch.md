...
- Run E2E binary smoke: `cargo run -p gardener --bin gardener -- --num-workers 3 --target 3 --config tools/gardener/tests/fixtures/configs/phase04-scheduler-stub.toml`.
